...
/* Variabile globale per la coda del test */
CharQueueADT q = NULL;
...
/**
 * @brief Verifica l'inserimento di un gran numero di elementi.
 */
...
/**
 * @brief Verifica la corretta gestione degli inserimenti e rimozioni ripetute.
 */
